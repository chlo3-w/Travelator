...
<!--            <div class="card">
                <div class="home-card-block">
                    ...
                    <h4 class="card-title w-50"><?php echo $home{0}->title; ?></h4>
                    <p class="card-text w-50"><?php echo $home{0}->content; ?></p>
                </div>
        ...
        <div class="carousel-item">
            <div class="card">
                <div class="home-card-block ">
                    if this is changed to the location being the name of the picture, the .jpg file path will need to be added
                    <img class="card-img float-left w-50" src=<?php echo "'views/images/" . $home{1}->city . ".jpg'"; ?> >
                    <h4 class="card-title"><?php echo $home{1}->title; ?></h4>
                    <p class="card-text"><?php echo $home{1}->content; ?></p>
                </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md home-categories">
            ...
            <div class="overlay">
                <span>
                    <a class="home-cat-link" href="?controller=post&action=readLocation&category=Budget">Budget</a>
                </span>
            </div>
        </div>
        <div class="col-md home-categories">
